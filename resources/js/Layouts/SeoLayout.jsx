        ...
        <div className="min-h-screen bg-primary-bg text-text-primary relative overflow-x-hidden mobile-no-min-height">
                ...
                <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 safe-area-inset-x">
                    <div className="flex justify-between h-16">
                        ...
                        <div className="-mr-2 flex items-center gap-2 sm:hidden">
                            {user && <ApiBalanceDisplay lazyLoad={true} />}
                            {user && <MobileNotificationBell />}
            ...
            <main className="py-12 safe-area-inset-y mobile-main">
                    ...
                    <div className="animate-fade-in">
                        ...
                        {user && <EmailVerificationBanner user={user} status={flash?.status} />}
