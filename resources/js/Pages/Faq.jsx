                        ...
                        "mainEntity": [
                            {
                                ...
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "379ТМ - это современная система управления задачами, специально разработанная для разработчиков и команд. Она включает в себя уникальный ИИ-ассистент, который позволяет управлять проектами и задачами на естественном языке."
                                }
                            },
                            {
                                "@type": "Question",
                        ...
                        {[
                            {
                                ...
                                answer: "379ТМ - это современная система управления задачами, специально разработанная для разработчиков и команд. Она включает в себя уникальный ИИ-ассистент, который позволяет управлять проектами и задачами на естественном языке."
                            },
                            {
                            ...
                            },
                            {
                                ...
                                answer: "Да, 379ТМ доступна бесплатно для всех пользователей. Вы можете создавать проекты, задачи, использовать ИИ-ассистента и все основные функции без ограничений."
                            },
                            {
                            ...
                            },
                            {
                                ...
                                answer: "Да, вы можете экспортировать данные о проектах, задачах и статистике в различных форматах для дальнейшего анализа или резервного копирования."
                            },
                            {
                                question: "Есть ли API для интеграции?",
                                answer: "Да, 379ТМ предоставляет REST API для интеграции с другими системами и автоматизации рабочих процессов. Документация API доступна для разработчиков."
                            },
                            {
