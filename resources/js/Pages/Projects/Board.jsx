                ...
                <div className="card">
                  <div className="flex flex-wrap md:flex-nowrap items-center gap-3 md:gap-4 justify-between">
                    ...
                    <button
                      ...
                      className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 font-medium px-4 py-2.5 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg ml-2 flex items-center gap-2 text-sm"
                      style={{ color: 'white' }}
                    >
