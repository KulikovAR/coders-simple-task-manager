                        ...
                        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 lg:flex-shrink-0">
                            ...
                            <div className="flex gap-2">
                                ...
                                <Link
                                    ...
                                    className="btn btn-accent inline-flex items-center text-center flex-1 sm:flex-none"
                                >
                                    <svg className="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                    </svg>
                                    <span className="hidden sm:inline">Гантт</span>
                                    <span className="sm:hidden">Гантт</span>
                                </Link>
                                <Link
                                    href={route('webhooks.index', project.id)}
                                    className="btn btn-info text-white inline-flex items-center text-center flex-1 sm:flex-none"
                                >
                                    <svg className="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="flex gap-2">
                                <Link
                                    ...
                                    className="btn btn-success text-white inline-flex items-center text-center flex-1 sm:flex-none"
                                >
                                    <svg className="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
