    ...
    return (
        ...
        >
            ...
            <div className="space-y-6">
                    ...
                    <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-2xl font-semibold text-white">{stats.projects_count || 0}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-2xl font-semibold text-white">{stats.tasks_count || 0}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-2xl font-semibold text-white">{stats.comments_count || 0}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        >
                            ...
                            <span className="text-white">Новый проект</span>
                        </Link>
                        ...
                        >
                            ...
                            <span className="text-white">Новая задача</span>
                        </Link>
                        ...
                        >
                            ...
                            <span className="text-white">Все проекты</span>
                        </Link>
                        ...
                        >
                            ...
                            <span className="text-white">Все задачи</span>
                        </Link>
                    </div>
                </div>
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
                    <h3 className="text-lg font-medium text-white mb-4">Последние активности</h3>
                    <div className="space-y-4">
                        <div className="flex items-center p-4 bg-gray-800 border border-gray-700 rounded-lg">
                            ...
                            <div className="flex-1">
                                <p className="text-white">Добро пожаловать в Task Manager!</p>
