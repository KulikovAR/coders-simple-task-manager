                    ...
                    <nav className="max-w-6xl mx-auto px-6 py-4">
                        <div className="flex justify-between items-center">
                            ...
                            <button
                                ...
                                className="md:hidden flex items-center justify-center w-10 h-10 rounded-lg bg-secondary-bg border border-border-color hover:bg-accent-blue/10 transition-colors"
                            >
                        ...
                        {/* Mobile Navigation */}
                        <div className={`md:hidden ${isMobileMenuOpen ? 'block' : 'hidden'} mt-4 pb-4 border-t border-border-color`}>
                            <div className="flex flex-col space-y-4 pt-4">
                                <a
                                    href="https://t.me/itteam379manager"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-text-secondary hover:text-text-primary transition-colors duration-300 flex items-center gap-2 text-sm py-2"
                                >
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/>
                                    </svg>
                                ...
                                {auth.user ? (
                                    <Link
                                        href={route('dashboard')}
                                        className="text-text-primary hover:text-text-secondary transition-colors font-medium py-2"
                                    >
                                        Дашборд
                                    </Link>
                                ) : (
                                    <>
                                        ...
                                        <Link
                                            href={route('register')}
                                            className="bg-accent-blue text-white px-6 py-3 rounded-full font-medium hover:bg-accent-blue/80 transition-all duration-300 text-center"
                                        >
                                            Регистрация
                                        </Link>
                                    </>
