...
import ScreenshotsSection from '@/Components/SeoLanding/ScreenshotsSection';
import BenefitsSection from '@/Components/SeoLanding/BenefitsSection';
import PricingSection from '@/Components/SeoLanding/PricingSection';
import CtaSection from '@/Components/SeoLanding/CtaSection';
                    ...
                    <nav className="max-w-7xl mx-auto px-6 py-4">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="hidden md:flex items-center gap-8 text-sm">
                                ...
                                {auth.user ? (
                                    <Link href={route('seo-stats.dashboard')} className="bg-gradient-to-r from-accent-blue to-accent-purple text-white px-5 py-2.5 rounded-lg font-medium hover:shadow-lg hover:shadow-accent-blue/20 transition-all duration-300 transform hover:-translate-y-0.5">
                                        Открыть дашборд
                                    </Link>
                                ) : (
                        ...
                        {isMobileMenuOpen && (
                            <div className="md:hidden mt-4 pt-4 border-t border-border-color/30 flex flex-col gap-5">
                                ...
                                {auth.user ? (
                                    <Link href={route('seo-stats.dashboard')} className="bg-gradient-to-r from-accent-blue to-accent-purple text-white px-5 py-2.5 rounded-lg font-medium text-center hover:shadow-lg hover:shadow-accent-blue/20 transition-all duration-300">
                                        Открыть дашборд
                                    </Link>
                                ) : (
                                    <div className="flex flex-col gap-4">
                                        <Link href={route('seo-stats.dashboard')} className="text-white hover:text-accent-blue transition-all duration-300">
                                            Вход
                                        </Link>
                                        <Link href={route('seo-stats.dashboard')} className="bg-gradient-to-r from-accent-blue to-accent-purple text-white px-5 py-2.5 rounded-lg font-medium text-center hover:shadow-lg hover:shadow-accent-blue/20 transition-all duration-300">
                                            Начать
