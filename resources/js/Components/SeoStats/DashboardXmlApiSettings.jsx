            ...
            <div className="space-y-6">
                <div className="border border-border-color rounded-lg p-4 bg-secondary-bg">
                    <h3 className="text-lg font-semibold text-text-primary mb-4 flex items-center gap-2">
                        ...
                        Yandex API
                        <a href={"https://xmlstock.com/"} target={"_blank"} className="relative self-stretch">
                            <span className="absolute inset-0 bg-white/20 rounded"></span>
                        ...
                        <span className="flex items-center text-white text-4xl font-bold mx-1 relative -top-1">/</span>
                    ...
                    <p className="text-sm text-text-muted mb-4">
                        ...
                        Можете вставить полный URL или заполнить поля отдельно. Можно использовать xmlstock или xmlriver
                    </p>
