...
const Footer = () => {
    ...
    const navLinks = [
        ...
        { title: 'ИИ-ассистент', href: '#ai-assistant' },
        { title: 'Интерфейс', href: '#screenshots' },
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <p className="text-gray-300 mb-6 max-w-md">
                                Современный таск-менеджер с ИИ-ассистентом для эффективного управления проектами. Проекты, спринты, канбан-доска и уведомления в Telegram.
                            </p>
