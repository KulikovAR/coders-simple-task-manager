...
export default function ProjectFileAttachments({ projectId, onFileDeleted }) {
    ...
    const loadAttachments = async () => {
        try {
            setLoading(true);
            const response = await fetch(`/api/file-upload?attachable_type=App\\Models\\Project&attachable_id=${projectId}`, {
                headers: {
        ...
        <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                    Файлы проекта ({attachments.length})
                </span>
            </div>
