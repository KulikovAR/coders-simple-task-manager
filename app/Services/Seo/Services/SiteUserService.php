...
class SiteUserService
{
    ...
    public function getSiteData(int $siteId): ?array
    {
        ...
        $siteData['public_token'] = $localSite->public_token;
    ...
    public function getSiteWithoutAuth(int $siteId): ?SiteDTO
    {
        return $this->siteService->getSite($siteId);
    }

    public function getSiteDataWithoutAuth(int $siteId): ?array
    {
        $site = $this->siteService->getSite($siteId);
