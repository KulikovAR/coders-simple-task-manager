...
class VerifyEmailNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line('Спасибо за регистрацию в нашем приложении!')
            ->line('Для завершения регистрации и получения полного доступа к функциям приложения, пожалуйста, подтвердите ваш email адрес, нажав на кнопку ниже:')
